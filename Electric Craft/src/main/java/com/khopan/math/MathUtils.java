...
public class MathUtils {
	...
	public static int intMap(int Number, int InputMin, int InputMax, int OutputMin, int OutputMax) {
		return (int) Math.round(MathUtils.map(Number, InputMin, InputMax, OutputMin, OutputMax));
	}
	...
	public static int protectedIntMap(int Number, int InputMin, int InputMax, int OutputMin, int OutputMax) {
		return (int) Math.round(MathUtils.protectedMap(Number, InputMin, InputMax, OutputMin, OutputMax));
	}
	...
	public static <T> T random(T... Inputs) {
		return Inputs == null ? null : Inputs[ThreadLocalRandom.current().nextInt(Inputs.length)];
	}
	...
	public static int factor(int Value, double Factor) {
